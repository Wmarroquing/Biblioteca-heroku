...
urlpatterns = [
    ...
    path('administrador/bibliotecas/', admin_views.BibliotecaView.as_view(), name='bibliotecas'),
    ...
    path('administrador/modificar_biblioteca/', admin_views.BibliotecaModificar.as_view(), name='modificar_biblioteca'),
    ...
    path('administrador/nueva_biblioteca/', admin_views.NuevaBiblioteca.as_view(), name='nueva_biblioteca'),
    ...
    path('obtener_biblioteca/', admin_views.GetBiblio.as_view(), name='obtener_biblioteca'),

    path('usuario/', user_views.LoginUserView.as_view(), name='user_login'),
